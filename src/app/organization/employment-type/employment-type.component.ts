...
export class EmploymentTypeComponent implements OnInit {
  ...
  public displayedColumns: string[] = ['employment_type_name'];
  ...
  add(params?: string) {
    this.router.navigate(['/organization/add-edit-employment-type'], {queryParams: {action: params}});
  }

  edit(data: any, params: any) {
    this.router.navigate(['/organization/add-edit-employment-type'], {queryParams: {id:data?.id, action: params}});
  }

  delete(data: any, params: string) {
    let action: string = "delete-employmentType";
  ...
  async onStatusChange(e:any, params: any) {
    let action = "update-employmentType";
      let param = {
        id: params?.id,
