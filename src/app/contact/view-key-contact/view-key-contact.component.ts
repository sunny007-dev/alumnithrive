...
@Component({
  selector: 'app-view-key-contact',
  templateUrl: './view-key-contact.component.html',
  styleUrls: ['./view-key-contact.component.scss']
})
export class ViewKeyContactComponent implements OnInit {
