...
@Component({
  selector: "app-alumni-social-channel",
  templateUrl: "./alumni-social-channel.component.html",
  styleUrls: ["./alumni-social-channel.component.scss"],
})
export class AlumniSocialChannelComponent implements OnInit {
