...
// Pie
export var pieChartLabels: string[] = ["Emergency", "Alert", "Critical", "Error", "Warning", "Notice", "Info", "Debug"];
export var pieChartData: number[] = [593, 678, 734, 453, 433, 200, 300, 986, 1000];
export var pieChartType: ChartType = 'pie';
export var pieChartColors: any[] = [{ backgroundColor: ["#B9391C", "#B9391C", "#E54A36", "#E54A36", "#ED8E02", "#64B050", "#1976D2", "#90CAF9"] }];
export var pieChartOptions: any = {
  responsive: true,
  maintainAspectRatio: false,
  title: {
    display: true,
    text: 'Log Viewer Module'
  }
