 ...
 */
  ...
  add() {
    this.router.navigate(["/careers-jobs/add-job"], {queryParams: {role_type:"alumni"}});
  }

  view(data: any) {
    this.router.navigate(['/careers-jobs/view-job'], {queryParams: { id: data?.id, type: "alumni-jobs", role_type:"alumni" }});
  }
      ...
      async searchData() {
        ...
        if (!isValue) {
          ...
          await this.userService
            ...
            .subscribe((res: any) => {
                this.alumniJobs = res?.data;
                this.dataSource.data = this.alumniJobs;
            });
        }
      }
